...
class HTMLComponentEditor(ContainerBase):
    ...
    def test_user_can_view_metadata(self):
        ...
        """
        self.html_editor.click_settings_button()
    ...
    def test_user_can_modify_display_name(self):
        ...
        """
        self.xblock_wrapper.open_settings_tab()
        self.xblock_wrapper.set_field_val('Display Name', 'New Name')
        self.xblock_wrapper.save_settings()
